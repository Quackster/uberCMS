...
$tpl->Write('<div class="habblet-container "><div class="cbb clearfix green "><h2 class="title">Tags</h2><div class="habblet box-content">');
...
$tpl->SetParam('page_title', 'Community');
