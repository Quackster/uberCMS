...
<div class="cbb clearfix white " style="padding: 15px;"> 
	...
	<b>What are VIP Points?</b><br />
	VIP Points is a special currency you can use to buy some cool extras.<br />
	<br />

	<b>How do I get VIP Points?</b><br />
	VIP Points need to be purchased with cash. Click the 'Buy' button above for more information
	about purchasing them.<br />
	<br />
