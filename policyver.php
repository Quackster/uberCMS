...
if (isset($_POST['confirm']))
{
	...
	if ($confirm == 'Yes, I accept the rules and I will speak English in the hotel.')
	{
	...
	{
		echo '<script type="text/javascript">alert(\'Sorry, but that is incorect. Please type the sentence carefully, taking note of punctiation and capitalization.\');</script>';
	}
}
...
$tpl->SetParam('page_title', 'Policy Verification');
